...
class NeuralNetwork:
    ...
    def add_processing_standard(self):
        self.pre_processing.append(["linear_standard", None, None, 0,
                                    0])  # contient ("linear_standard", list_sigma_coordinate_RHS, list_mean_coordinate_RHS, sigma_sol, mean_sol)
    ...
    def save_hdf5(self, name=None, path=None):
        """ Saves the model with the given name in HDF5 format. If no name is given, the previous name is used"""
        if name is None:
